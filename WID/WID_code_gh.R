...
ggplot(wid_1p_averages, mapping=aes(x=Year, y=participation, color=country, label=country))+
  ...
  labs(x="Year",
       ...
       subtitle="Pre-tax national income includes labor and capital income. It does not account for  
       taxes or transfers. In 2019, USA's top 1% held <span style='color:#8DA0CB;'>**18.7%** </span>of pre-tax national income,  
